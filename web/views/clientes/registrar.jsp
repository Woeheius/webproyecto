...
<div class="container mt-5">
    <h2 class="text-center" style="color: #4A148C;">Registrar Cliente</h2>
    <form action="ClienteController?action=agregar" method="post" class="shadow p-4 rounded bg-white">
